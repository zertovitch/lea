...
package LEA_Resource_GUI is
  ...
  type HAC_Option_Box_Type is new Window_Type with record

    Group_Remarks : Group_Box_Type;
    Remarks_Level_1_Button : Radio_Button_Type;
    Remarks_Level_2_Button : Radio_Button_Type;
    IDCANCEL : Dialog_Button_Type;    --  Closes parent window after click
    IDCANCEL_permanent : Button_Type;  --  Doesn't close parent window after click
    IDOK : Default_Dialog_Button_Type;    --  Closes parent window after click
    IDOK_permanent : Default_Button_Type;  --  Doesn't close parent window after click
  end record; -- HAC_Option_Box_Type
  ...
  package Version_info is
    ...
    FileVersion : constant String := "0.94";
    LegalCopyright : constant String := "Copyright © Gautier de Montmollin 2017 .. 2026";
  ...
  Group_Remarks                   : constant :=  40118;
  Remarks_Level_1_Button          : constant :=  40119;
  Remarks_Level_2_Button          : constant :=  40120;
  IDM_HAC_options                 : constant :=  40121;
  IDM_Alire_Mode                  : constant :=  40122;
